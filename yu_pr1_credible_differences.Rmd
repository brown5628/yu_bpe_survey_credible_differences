...
select 
	...
	case 
		when pr1.[12_satisfied_year_up_quality_service_support] = 'Completely satisfied' then 5
...
results_part <- data.frame(base_cohort = ymd("1900-01-01"), grain_value = as.character("A"), kpi_columns = as.numeric(0), es_pct_less_rope = as.numeric(0), es_pct_in_rope = as.numeric(0), es_pct_greater_rope = as.numeric(0))
...
k <- 1  
  ...
  results_part[nrow(results_part) + 1, ] <- list(ymd(e), f, g, temp_results_part[1], temp_results_part[2], temp_results_part[3])
#}
```
...
# rename columns
colnames(final_results_part) <- c("base_cohort", "grain_value", "kpi_question", "es_pct_less_rope", "es_pct_in_rope", "es_pct_greater_rope")
...
```{r}
# generate empty data frame to accept testing results
results_hist_off <- data.frame(base_cohort = ymd("1900-01-01"), comparison_cohort = ymd("1900-01-01"), grain_value = as.character("A"), kpi_columns = as.numeric(0), es_pct_less_rope = as.numeric(0), es_pct_in_rope = as.numeric(0), es_pct_greater_rope = as.numeric(0))
...
i <- 1
  ...
  results_hist_off[nrow(results_hist_off) + 1, ] <- list(ymd(a), ymd(d), b, c, temp_results_hist_off[1], temp_results_hist_off[2], temp_results_hist_off[3])
#}
```
...
# rename columns
colnames(final_results_hist_off) <- c("base_cohort", "comparison_cohort", "grain_value", "kpi_question", "es_pct_less_rope", "es_pct_in_rope", "es_pct_greater_rope")
...
```{r}
# generate empty data frame to accept testing results
results_hist_on <- data.frame(base_cohort = ymd("1900-01-01"), comparison_cohort = ymd("1900-01-01"), grain_value = as.character("A"), kpi_columns = as.numeric(0), es_pct_less_rope = as.numeric(0), es_pct_in_rope = as.numeric(0), es_pct_greater_rope = as.numeric(0))
...
j <- 1
  ...
  results_hist_on[nrow(results_hist_on) + 1, ] <- list(ymd(a), ymd(d), b, c, temp_results_hist_on[1], temp_results_hist_on[2], temp_results_hist_on[3])
#}
```
...
# rename columns
colnames(final_results_hist_on) <- c("base_cohort", "comparison_cohort", "grain_value", "kpi_question", "es_pct_less_rope", "es_pct_in_rope", "es_pct_greater_rope")
...
```{r}
# generate empty data frame to accept testing results
results_hist_l3 <- data.frame(base_cohort = ymd("1900-01-01"), comparison_cohort = ymd("1900-01-01"), grain_value = as.character("A"), kpi_columns = as.numeric(0), es_pct_less_rope = as.numeric(0), es_pct_in_rope = as.numeric(0), es_pct_greater_rope = as.numeric(0))
...
h <- 1
  ...
  results_hist_l3[nrow(results_hist_l3) + 1, ] <- list(ymd(a), ymd(d), b, c, temp_results_hist_l3[1], temp_results_hist_l3[2], temp_results_hist_l3[3])
#}
```
...
# rename columns
colnames(final_results_hist_l3) <- c("base_cohort", "comparison_cohort", "grain_value", "kpi_question", "es_pct_less_rope", "es_pct_in_rope", "es_pct_greater_rope")
